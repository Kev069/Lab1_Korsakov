...
import java.util.Iterator; // Added Iterator import

public class Main {

    public static void main(String[] args) {
        int listSize = 100000; // List size
        int insertionSize = 1000; // Number of elements to insert
        ...
        // Output information about the number of elements
